...
export class InMemoryCharacterRepository implements ICharacterRepository {
    ...
    constructor() {
        ...
        this.storage.set(demoId, {
            ...
            name: 'メル＝アルヴェナ＝ルミナ',
            profile: {
                // name is top-level, not in profile
            ...
            logs: [
                ...
                { id: '2', type: 'GROWTH', timestamp: 1, statKey: 'Science', value: 6 },
                { id: '3', type: 'GROWTH', timestamp: 1, statKey: 'MagicKnowledge', value: 6 },
                ...
                // Element Bonus
                { id: '8', type: 'GROWTH', timestamp: 1, statKey: 'InsightCheck', value: 3, description: 'Element Bonus (Light)' },
