                            ...
                            <div className="flex items-center gap-2 group flex-wrap">
                                {isEditMode && onNameChange ? (
                                    <div className="grid items-center">
                                        <span className="text-3xl font-bold tracking-tight py-1 px-2 invisible col-start-1 row-start-1 whitespace-pre">
                                            {tempName || ' '}
                                        </span>
                                        <Input
                                            value={tempName}
                                            ...
                                            className="text-3xl font-bold tracking-tight h-auto py-1 px-2 w-full min-w-[1em] col-start-1 row-start-1"
                                        />
                                    </div>
                                ) : (
